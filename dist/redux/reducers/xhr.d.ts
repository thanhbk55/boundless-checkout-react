export declare const pushPromise: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    promise: Promise<any>;
}, string>, cleanPromises: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>, resetXhrState: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>;
